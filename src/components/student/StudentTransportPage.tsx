...
import { useStudentTransport, useBusRoutes } from '@/hooks/useTransportation';
...
const demoTransport = {
  ...
  route: {
    ...
    stops: ['Green Park Metro', 'Hauz Khas', 'IIT Gate', 'School Campus'],
    morning_time: '07:30',
    evening_time: '14:30',
    distance_km: 12,
    monthly_fee: 2500,
...
export function StudentTransportPage() {
  ...
  const displayTransport = isDemo ? demoTransport : transport;
    ...
    return (
      <div className="p-4 md:p-6 pb-20 lg:pb-6 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Your school transport details</p>
        </div>
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground">
              You don't have any transport facility assigned. Please contact the school administration for more information.
            </p>
          </CardContent>
        </Card>
                ...
                {routes.filter(r => r.is_active).map((route) => (
                  <div key={route.id} className="p-3 border rounded-lg">
                    ...
                    <p className="text-sm text-primary font-medium mt-1">
                      {formatCurrency(route.monthly_fee)}/month
                    </p>
                  </div>
                ))}
              </div>
  ...
  return (
    <div className="p-4 md:p-6 pb-20 lg:pb-6 space-y-6">
      ...
      {/* Live Tracking */}
      {!isDemo && displayTransport.bus_id && displayTransport.route_id && (
        <LiveBusMap
          busId={displayTransport.bus_id}
          routeId={displayTransport.route_id}
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                <p className="text-sm text-blue-700">Your Pickup Point</p>
